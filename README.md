...
HP developed Tesseract, a free and open-source OCR engine, between 1984 and 1994.
It arose out of nowhere for the 1995 UNLV Annual Test of OCR Accuracy, shone brightly with its results, and then vanished behind the same shroud of secrecy under which it had been built.
For the first time, details about the architecture and algorithms may be revealed.


Tesseract began as a PhD research project at HP Labs in Bristol and immediately gained momentum as a possible software and/or hardware add-on for HP's flatbed scanner series.


The fact that commercial OCR engines were still in their infancy at the time provided impetus, since they failed catastrophically on anything less than the best quality print.
After a combined effort between HP Labs Bristol and HP's scanning company in Colorado, Tesseract had a significant accuracy edge over commercial engines, but it did not become a product.
The next stage of its growth occurred at HP Labs Bristol as an OCR for compression research project.
Rather than focusing on basic correctness, the effort aimed to improve rejection efficiency.
By the end of 1994, development on this project had come to a standstill.
The engine was taken to the University of Nevada, Las Vegas, for the 1995 Annual Test of OCR Accuracy, where it outperformed commercial engines at the time.
Tesseract was released as open source by HP in late 2005.
It is currently available at https://github.com/tesseract-ocr.
